...
import ModalRanking from "./modal-ranking";
  ...
  return(
    ...
    <div className="drawer-content flex flex-col">
      ...
      <div className="w-full navbar bg-base-300 flex flex-row justify-between p-0 sm:p-2 min-h-0">
        ...
        <Link className="sm:flex-1 btn btn-ghost text-xl" href={'/'}>REOLE</Link>
        <div className="sm:flex-1 sm:flex sm:flex-row sm:justify-end">
          <ul className="menu menu-horizontal sm:gap-2">
            <button className="btn btn-ghost tooltip tooltip-bottom" onClick={() => openModal('modalRanking')} data-tip="classement"><FontAwesomeIcon icon={faRankingStar} /></button>
            <button className="btn btn-ghost tooltip tooltip-bottom" onClick={() => openModal('modalSettings')} data-tip="paramètres"><FontAwesomeIcon icon={faGear} /></button>
    ...
    <div className="drawer-side">
      ...
      <div className="flex flex-col w-80 min-h-full bg-base-200 p-4 text-justify gap-5">
        <div className="flex flex-col gap-2">
          ...
          <p>La création de ce site a nécessité l'utilisation de l'appplication mobile Reo. (<Link href="https://play.google.com/store/apps/details?id=pf.culture.sti.reo&hl=ln" className="underline">Play store</Link>/<Link href="https://apps.apple.com/fr/app/reo/id1245650858" className="underline">App store</Link>)</p>
          ...
          <p>Les icônes proviennent de <Link href="https://fontawesome.com/" className="underline">Font Awesome</Link>.</p>
          <p>Le nom "REOLE" est un jeux de mot entre "reo" et <Link href="https://www.nytimes.com/games/wordle/index.html" className="underline">Wordle</Link>, dont ce site s'inspire très fortement.</p>
          <p>Ce site n'a aucun but lucratif. Il est hébergé à titre gracieux et libre d'utilisation.</p>
        </div>
        <div className="flex flex-col gap-2">
          <h2 className="text-xl">Contact</h2>
          <p><Link href="https://github.com/HUANGManutea" className="underline"><FontAwesomeIcon icon={faGithub} /> Github: HUANGManutea</Link></p>
          <p><Link href="https://twitter.com/HManutea" className="underline"><FontAwesomeIcon icon={faXTwitter} /> X/Twitter: HManutea</Link></p>
        </div>
      </div>
    </div>
  </div>
