  ...
  return (
    <dialog id="modalTuto" className="modal">
      <div className="modal-box">
        ...
        <p className="py-2">Vous pouvez taper avec votre clavier, ou utiliser le clavier virtuel adapté à la langue tahitienne:</p>
        <ul className="list-disc">
          <li>La touche &quot;entrée&quot; valide une tentative</li>
          <li>Le &apos;eta est une consonne, et compte donc comme une lettre, le &apos;eta correspond à la touche &quot;apostrophe&quot;</li>
          <li>La touche &quot;⇧&quot; permet d'afficher les tārava, elle correspond à la touche &quot;Majuscule&quot; du clavier</li>
        </ul>
        ...
        <ul className="flex flex-col gap-2">
          <li>
            <div className="flex flex-row items-center gap-2">
              <div className="h-16 aspect-square text-xl text-bold text-center border text-white flex flex-col items-center justify-center cell-correct"><span>A</span></div>
              <span>: la lettre est correctement positionnée</span>
            </div>
          </li>
          <li>
            <div className="flex flex-row items-center gap-2">
              <div className="h-16 aspect-square text-xl text-bold text-center border text-white flex flex-col items-center justify-center cell-misplaced"><span>A</span></div>
              <span>: la lettre est mal positionnée</span>
            </div>
          </li>
          <li>
            <div className="flex flex-row items-center gap-2">
              <div className="h-16 aspect-square text-xl text-bold text-center border text-white flex flex-col items-center justify-center"><span>A</span></div>
